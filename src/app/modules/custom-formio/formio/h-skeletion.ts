...
const COMPONENT_OPTIONS: FormioCustomComponentInfo = {
  type: 'hSkeleton', // custom type. Formio will identify the field with this type.
  selector: 'h-skeleton', // custom selector. Angular Elements will create a custom html tag with this selector
  title: 'Human Skeleton', // Title of the component
...
export function registerHSkeletonComponent(injector: Injector) {
  registerCustomFormioComponent(COMPONENT_OPTIONS, HSkeletonComponent, injector)
}